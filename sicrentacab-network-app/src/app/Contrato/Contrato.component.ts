...
export class ContratoComponent implements OnInit {
  ...
  constructor(public serviceContrato: ContratoService, fb: FormBuilder) {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'com.sicmx.sicrentacab.Contrato',
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceContrato.updateAsset(form.get('IdContrato').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.IdContrato) {
        formObject.IdContrato = result.IdContrato;
      } else {
        formObject.IdContrato = null;
      }
